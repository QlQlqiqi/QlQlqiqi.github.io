 ...
 * Mon May 09 2022 17:13:09 GMT+0800 (中国标准时间)
...
addHTMLElement('button', 'unfold_button', 'TO', ['QUERYSELECTOR', '#v3d-container'], false);
setHTMLElemAttribute('innerHTML', 'unfold', ['QUERYSELECTOR', '#unfold_button'], false);
eventHTMLElem('click', ['QUERYSELECTOR', '#unfold_button'], false, function(event) {
  if (unfolded_knife == false) {

    operateAnimation('PLAY', getAnimations(['GROUP', 'animated_parts']), null, null, 'LoopOnce', 1,
            function() {
      unfolded_knife = true;
      setHTMLElemStyle('display', 'block', 'an_1', false);
    }, undefined, false);

        }
});

addHTMLElement('button', 'fold_button', 'TO', ['QUERYSELECTOR', '#v3d-container'], false);
setHTMLElemAttribute('innerHTML', 'fold', ['QUERYSELECTOR', '#fold_button'], false);
eventHTMLElem('click', ['QUERYSELECTOR', '#fold_button'], false, function(event) {
...
eventHTMLElem('click', ['QUERYSELECTOR', '#unfold-button-ext'], true, function(event) {
  if (unfolded_knife == false) {
...
eventHTMLElem('click', ['QUERYSELECTOR', '#fold-button-ext'], true, function(event) {
  if (unfolded_knife == true) {
    setHTMLElemStyle('display', 'none', 'an_1', false);
...
handleAnnot(true, '1', 'big_knife_annotation', 'Point of interest #1', 'an_1', undefined);
setHTMLElemStyle('display', 'none', 'an_1', false);
